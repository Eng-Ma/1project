!function () {
    "use strict";
    var a, t, o, e, n, s, d, l = document.querySelector(".navbar-menu").innerHTML, i = 6, r = "en",
        c = localStorage.getItem("language");
    document.getElementById("des-dev").innerHTML = "تم التصميم والبرمجة بواسطة فريق <a target='_blank' href=\"https://resoen.com\">ريزوين</a>"
    document.getElementById("des-dev").style.display = "block"
    function m(e) {
    ...
    function f(e) {
        if (e.target && e.target.matches("a.nav-link span")) if (0 == b(e.target.parentElement.nextElementSibling)) e.target.parentElement.nextElementSibling.classList.add("dropdown-custom-right"), e.target.parentElement.parentElement.parentElement.parentElement.classList.add("dropdown-custom-right"), e.target.parentElement.nextElementSibling.querySelectorAll(".menu-dropdown").forEach(function (e) {
            e.classList.add("dropdown-custom-right")
        }); else if (1 == b(e.target.parentElement.nextElementSibling) && 1848 <= window.innerWidth) for (var t = document.getElementsByClassName("dropdown-custom-right"); 0 < t.length;) t[0].classList.remove("dropdown-custom-right");
        if (e.target && e.target.matches("a.nav-link")) if (0 == b(e.target.nextElementSibling)) e.target.nextElementSibling.classList.add("dropdown-custom-right"), e.target.parentElement.parentElement.parentElement.classList.add("dropdown-custom-right"), e.target.nextElementSibling.querySelectorAll(".menu-dropdown").forEach(function (e) {
            e.classList.add("dropdown-custom-right")
        }); else if (1 == b(e.target.nextElementSibling) && 1848 <= window.innerWidth) for (t = document.getElementsByClassName("dropdown-custom-right"); 0 < t.length;) t[0].classList.remove("dropdown-custom-right")
    }
    ...
    function I() {
        ...
        var a = i, o = document.querySelectorAll("ul.navbar-nav > li.nav-item"), n = "", s = "";
